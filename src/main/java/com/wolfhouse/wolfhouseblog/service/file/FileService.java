...
public interface FileService {
     ...
     */
    FileUploadResultVo uploadAvatar(ClientChunkFileUploadDto dto) throws Exception;
     ...
     */
    ChunkFilePermitVo startUploadAvatar(ChunkFilePermitDto dto) throws Exception;
